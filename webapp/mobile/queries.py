...
def queries(request_result: MultiDict) -> Tarif:
...
def standart_queries(request_result: MultiDict, tarifs_list: Tarif) -> Tarif:
...
def queries_without_sms(request_result: MultiDict) -> Tarif:
